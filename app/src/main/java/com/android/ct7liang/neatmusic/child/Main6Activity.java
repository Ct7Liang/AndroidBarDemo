...
public class Main6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view2 = View.inflate(this, R.layout.window_dialog_6, null);
        ...
        ad2 = new Dialog(this);
        ad2.getWindow().addFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL); //设置FLAG_NOT_TOUCH_MODAL
